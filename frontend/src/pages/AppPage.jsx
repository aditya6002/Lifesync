...
export default function AppPage({ user, onLogout }) {
  ...
  return (
    <div style={{ display:"flex", height:"100vh", background:C.bg, overflow:"hidden" }}>
      ...
      {/* Ambient glow */}
      <div style={{ position:"fixed", top:-150, left:220, width:600, height:600, borderRadius:"50%", background:"radial-gradient(circle,rgba(124,58,237,.06) 0%,transparent 70%)", pointerEvents:"none", zIndex:0 }} />
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden", position:"relative", zIndex:1 }}>
        ...
        {/* Screen area */}
        <div key={active} className="screen-in" style={{ flex:1, overflowY:"auto", padding:22 }}>
          {screens[active]}
        </div>
      </div>
