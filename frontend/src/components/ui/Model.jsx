    ...
    >
      <div
        ...
        style={{
          ...
          background: C.bg3, border: `1px solid ${C.glassBorder}`,
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 17, color: C.text, fontWeight: 700 }}>
            {title}
          </span>
          <button
            onClick={onClose}
            style={{
              background: "rgba(255,255,255,.06)", border: "none", color: C.textMid,
  ...
  return (
    <Modal title={title} onClose={onClose} wide>
      ...
      <div style={{
        ...
        paddingTop: 16, borderTop: `1px solid ${C.glassBorder}`,
      }}>
  ...
  return (
    <div style={{
      ...
      <div
        className="modal-in"
        style={{
          padding: 28, maxWidth: 340, width: "90%",
          background: C.bg3, border: `1px solid ${C.glassBorder}`,
          borderRadius: 20,
        }}
      >
        <div style={{ fontSize: 15, color: C.text, marginBottom: 20, lineHeight: 1.65 }}>
          {message}
        </div>
